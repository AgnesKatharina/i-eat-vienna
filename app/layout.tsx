...
export const metadata = {
  ...
  applicationName: "I Eat Vienna",
  creator: "I Eat Vienna Team",
  publisher: "I Eat Vienna",
  metadataBase: new URL("https://i-eat-vienna.vercel.app"),
  openGraph: {
    type: "website",
    siteName: "I Eat Vienna",
    title: "I Eat Vienna",
    description: "Food ordering and inventory management system",
  },
    generator: 'v0.dev'
  ...
  return (
    <html lang="en">
      <head>
        ...
        <meta name="apple-mobile-web-app-title" content="I Eat Vienna" />
        <meta name="mobile-web-app-capable" content="yes" />
        <meta name="application-name" content="I Eat Vienna" />
